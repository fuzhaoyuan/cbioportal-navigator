 ...
 * MCP server that navigates users to the right cBioPortal pages
 */
...
export class CbioportalNavigator {
    ...
    private setupHandlers(): void {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async request => {
            ...
            try {
                ...
                switch (name) {
                    case 'resolve_and_build_url':
                        result = await handleResolveAndBuildUrl(args as any);
                        break;
